...
const { listLeaveType, getCreateLeaveType, postCreateLeaveType,getUpdateLeaveType,putUpdateLeaveType,getRemoveLeaveType,getViewLeaveType,
  listLeaveApprove,getCreateLeaveApprove,postCreateLeaveApprove,getUpdateLeaveApprove,putUpdateLeaveApprove,getRemoveLeaveApprove,getViewLeaveApprove,
  listLeaveQuotaMain,getCreateLeaveQuota,postCreateLeaveQuota,
  listLeaveDoc,getCreateLeaveDoc,getCreateLeaveDocID,postCreateLeaveDoc,getUpdateLeaveDoc,putUpdateLeaveDoc,getRemoveLeaveDoc,getViewLeaveDoc} = require('../controllers/leave')
...
router.get('/leaveType', isAuthenticated, listLeaveType)
router.get('/leaveType/Add', isAuthenticated, getCreateLeaveType)
router.post('/leaveType/Add', isAuthenticated, postCreateLeaveType)
router.get('/leaveType/Edit/:id', isAuthenticated,getUpdateLeaveType)
router.post('/leaveType/Edit/:id', isAuthenticated,putUpdateLeaveType)
router.get('/leaveType/Del/:id', isAuthenticated,getRemoveLeaveType)
router.get('/leaveType/View/:id', isAuthenticated,getViewLeaveType)

router.get('/leaveApprove', isAuthenticated,listLeaveApprove)
router.get('/leaveApprove/Add', isAuthenticated,getCreateLeaveApprove)
router.post('/leaveApprove/Add', isAuthenticated,postCreateLeaveApprove)
router.get('/leaveApprove/Edit/:id', isAuthenticated,getUpdateLeaveApprove)
router.post('/leaveApprove/Edit/:id', isAuthenticated,putUpdateLeaveApprove)
router.get('/leaveApprove/Del/:id', isAuthenticated,getRemoveLeaveApprove)
router.get('/leaveApprove/View/:id', isAuthenticated,getViewLeaveApprove)

router.get('/leaveQuotaMain', isAuthenticated,listLeaveQuotaMain) 
router.get('/leaveQuota/Add/:id', isAuthenticated,getCreateLeaveQuota)
router.post('/leaveQuota/Add/:id', isAuthenticated,postCreateLeaveQuota)

router.get('/leaveDocMain', isAuthenticated,listLeaveDoc)
router.get('/leaveDoc/:id', isAuthenticated,getCreateLeaveDoc)
router.get('/leaveDoc/Add/:id', isAuthenticated,getCreateLeaveDocID)
router.post('/leaveDoc/Add/:id',isAuthenticated,postCreateLeaveDoc, upload.single('image'))
router.get('/leaveDoc/Edit/:id', isAuthenticated,getUpdateLeaveDoc)
router.post('/leaveDoc/Edit/:id',isAuthenticated,putUpdateLeaveDoc, upload.single('imageE'))
router.get('/leaveDoc/Del/:id', isAuthenticated,getRemoveLeaveDoc)
router.get('/leaveDoc/View/:id', isAuthenticated,getViewLeaveDoc) 
